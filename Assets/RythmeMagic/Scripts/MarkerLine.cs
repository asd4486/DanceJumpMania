    ...
    public class MarkerLine : MonoBehaviour
    {
        ...
        void AssignMaterials()
        {
            if (lineMat != null)
            {
                ...
                meshRenderer.material.mainTextureScale = new Vector3(1, textureTiling);
            }
        }
        ...
        public void GenerateMesh(Vector3[] points)
        {
            ...
            {
                Vector3 localUp = (usePathNormals) ? Vector3.Cross(vectexPath.GetTangent(i), vectexPath.GetNormal(i)) : vectexPath.up;
